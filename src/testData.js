...
export const yourRandomOptions = [
  {
    _id: "1",
    ownerID: "you",
    visibility: "public",
    title: "SWN Classes",
    description: "All classes from the game Stars Without Number",
    type: "list",
    optionsList: [
      "Expert",
      "Warrior",
  ...
  },
  {
    ...
    visibility: "public",
    title: "SWN Levels",
    description: "Normal level range for the game Stars Without Number",
    type: "range",
    start: 1,
    end: 10,
    step: 1,
...
export const featuredRandomOptions = [
  {
    _id: "3",
    ownerID: "owner4",
    visibility: "public",
    title: "D&D 5E Classes",
    description: "All classes from the game Dungeons & Dragons, 5th Edition",
    type: "list",
    optionsList: [
      "Barbarian",
      "Bard",
  ...
  },
  {
    ...
    description:
      "A range of somewhat average human heights in a fantasy world.",
    type: "range",
    start: 1.2,
    end: 2.4,
    step: 0.1,
  },
  {
    ...
    ownerID: "owner5",
    visibility: "public",
    description: "Half-elf names, taken from fantasynamegenerators.com",
...
export const yourThemeSongs = ["themeSong1", "themeSong2", "themeSong3"];
export const featuredThemeSongs = ["themeSong4", "themeSong5", "themeSong6"];
